...
public class SubResourceDetailDataAdapter extends BaseAdapter {
    private List<SubResourceDetailAudios> audioList;
    private final LayoutInflater mInflater;
    private Context mContext;
    private String mstr_lang;
    private ArrayList<SubResourceDetailAudios> arraylist;




    public SubResourceDetailDataAdapter(Context applicationContext, List<SubResourceDetailAudios> audioList, String language) {
        mInflater = LayoutInflater.from(applicationContext);
        this.mstr_lang = language;
        this.mContext= applicationContext;
        this.audioList = audioList;
        this.arraylist = new ArrayList<SubResourceDetailAudios>();
