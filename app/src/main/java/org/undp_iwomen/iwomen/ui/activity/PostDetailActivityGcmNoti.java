...
public class PostDetailActivityGcmNoti extends BaseActionBarActivity implements AbsListView.OnScrollListener, View.OnClickListener {
    ...
    String mstrReturn, mstrPostReturn;
    ...
    private FacebookCallback<Sharer.Result> shareCallback = new FacebookCallback<Sharer.Result>() {
        ...
        private void showResult(String title, String alertMessage) {
            new AlertDialog.Builder(PostDetailActivityGcmNoti.this)
                    .setTitle(title)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog = new ProgressDialog(PostDetailActivityGcmNoti.this);
    ...
    private void init() {
        ...
        //TODO CHECK LOGIN OR NOT When  noti come
        ...
        //TODO id
        Intent i = getIntent();
        postId = i.getStringExtra("Post_ID");//"2185";//
        ...
        adapter = new CommentAdapter(PostDetailActivityGcmNoti.this, listComment);
            ...
            if (postType.equalsIgnoreCase("iWomenPost")) {
                SMKserverStringConverterAPI.getInstance().getService().postCheckiWomenPostLike(postId, user_id, new Callback<String>() {
                    ...
                    public void success(String s, Response response) {
                        mstrReturn = s.toString().trim();

                        if (mstrReturn.equals("true") || mstrReturn.equalsIgnoreCase("true")) {//s.toString() == "true" || s.equalsIgnoreCase("true") || s.equals("true")
                            mLikeAnimatedButton.setEnabled(false);
                            mLikeAnimatedButton.setClickable(false);
                            mLikeAnimatedButton.setmCheckedDrawable();

                            mSocialNoEarLikeAnimatedButton.setClickable(false);
                            mSocialNoEarLikeAnimatedButton.setmCheckedDrawable();

                        } else {
                            mLikeAnimatedButton.setEnabled(true);
                            mLikeAnimatedButton.setClickable(true);
                ...
                SMKserverStringConverterAPI.getInstance().getService().postCheckPostLike(postId, user_id, new Callback<String>() {
                    @Override
                    public void success(String s, Response response) {
                        mstrPostReturn = s.toString().trim();

                        if (mstrPostReturn.equals("true") || mstrPostReturn.equalsIgnoreCase("true")) {//s.toString() == "true" || s.equalsIgnoreCase("true") || s.equals("true")
    ...
    private void setPostItem(final IWomenPost item) {
        ...
        final List<CommentItem> comment = StoreUtil.getInstance().selectFrom("commentlist");
                ...
                public void success(List<Sticker> stickers, Response response) {
                    ...
                    if (stickerArrayList.size() > 0) {
                        ...
                        if (sticker_paginater <= 1) {
                            ...
                            mAdapter = new StickerGridViewAdapter(PostDetailActivityGcmNoti.this, mContext, stickerArrayList);
    ...
    public void initEmojiIcon() {
        boolean isLargerLollipop = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP);
    ...
    public void getCommentByPagination() {
        if (Connection.isOnline(mContext)) {
            ...
            NetworkEngine.getInstance().getCommentlistByPostIDByPagination(paginater, postObjId, new Callback<List<CommentItem>>() {
                @Override
                public void success(List<CommentItem> commentItems, Response response) {
        ...
        switch (view.getId()) {
                ...
                /***********EPP functions **************/
                    ...
                    if (iWomenPost.getPostUploadName().equalsIgnoreCase("Wai Wai")) {
                        ...
                        if (!isPlaying) {
                            ...
                            mMedia.start();
                            if (mMedia == null) {
                                mMedia = MediaPlayer.create(PostDetailActivityGcmNoti.this, R.raw.wai_wai_audio);
            ...
            case R.id.social_audio:
                if (mstrAudioFilePath.length() == 10) {
                    SKToastMessage.showMessage(PostDetailActivityGcmNoti.this, getResources().getString(R.string.resource_coming_soon_eng), SKToastMessage.ERROR);
                }
    ...
    private void showError(int messageId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(PostDetailActivityGcmNoti.this);
