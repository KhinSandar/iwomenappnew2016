...
*/
    ...
    private void showImage(ChosenFile file, View view) {
        ...
        ResizableImageView ivImage = (ResizableImageView) view.findViewById(R.id.ivImage);
        if (image.getThumbnailSmallPath() != null) {
            ...
            File croppedImageFile = new File(image.getThumbnailPath());
            ivImage.setImageBitmap(BitmapFactory.decodeFile(croppedImageFile.getAbsolutePath()));
        }
