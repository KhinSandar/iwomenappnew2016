...
public class NewPostFragment extends Fragment implements View.OnClickListener, ImageChooserListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SharedPreferences sharePrefLanguageUtil = getActivity().getSharedPreferences(Utils.PREF_SETTING, Context.MODE_PRIVATE);
    ...
    void performPostUpload(){
        ...
        NetworkEngine.getInstance().postCreateNewPost(content,
                content_type,
                content_mm,
                postUploadName,
                null,
    ...
    public void uploadImage(){
        ...
        NetworkEngine.getInstance().postPostPhoto(multipartTypedOutput, new Callback<PhotoUpload>() {
            @Override
