...
public class UserPostAPI {
    private static UserPostAPI mInstance;
    private UserPostService mService;
    ...
    public UserPostAPI(){
        ...
        mService = restAdapter.create(UserPostService.class);
    ...
    public static UserPostAPI getInstance(){
        if(mInstance == null){
            mInstance = new UserPostAPI();
        }
        return  mInstance;
    }
