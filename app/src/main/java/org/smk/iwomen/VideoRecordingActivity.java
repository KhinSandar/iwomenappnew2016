...
import org.smk.adapter.SizeAdapter;
import org.smk.application.StorageUtils;
...
public class VideoRecordingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!StorageUtils.checkExternalStorageAvailable()) {
			SKToastMessage.showMessage(this, getResources().getString(R.string.not_enough_storage), SKToastMessage.ERROR);
			return;
		}
	...
	private void initVideoSizeSpinner() {
		...
		if (Build.VERSION.SDK_INT >= 11) {
			...
			if(sizes != null && sizes.size() > 0){
				...
				SKToastMessage.showMessage(this, "Cann't get camera : "+ sizes, SKToastMessage.ERROR);
			}
		}
		else {
