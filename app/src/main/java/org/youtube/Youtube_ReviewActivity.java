...
public class Youtube_ReviewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.youtube_activity_review);
    ...
    private void loadAccount() {
        ...
        mChosenAccountName = sp.getString(Youtube_MainActivity.ACCOUNT_KEY, null);
    ...
    public void uploadVideo(View view) {
        ...
        if (mFileUri != null) {
            Intent uploadIntent = new Intent(this, Youtube_UploadService.class);
            uploadIntent.setData(mFileUri);
            uploadIntent.putExtra(Youtube_MainActivity.ACCOUNT_KEY, mChosenAccountName);
