...
import org.youtube.util.NetworkSingleton;
import org.youtube.util.Upload;
import org.youtube.util.Utils;
import org.youtube.util.VideoData;
 ...
 */
public class Youtube_MainActivity extends Activity implements
        Youtube_UploadsListFragment.Callbacks {
    ...
    private Youtube_UploadsListFragment mYoutubeUploadsListFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isCorrectlyConfigured()) {
            ...
            credential = GoogleAccountCredential.usingOAuth2(
                    getApplicationContext(), Arrays.asList(Youtube_Auth.SCOPES));
    ...
    private boolean isCorrectlyConfigured() {
        ...
        if (Youtube_Auth.KEY.startsWith("Replace")) {
            return false;
        }
        if (Youtube_Constants.UPLOAD_PLAYLIST.startsWith("Replace")) {
            return false;
        }
        return true;
    }
     ...
     * static variables defined in {@link Youtube_Auth} and {@link Youtube_Constants}.
     */
        ...
        switch (requestCode) {
            ...
            case RESULT_PICK_IMAGE_CROP:
                if (resultCode == RESULT_OK) {
                    ...
                    if (mFileURI != null) {
                        Intent intent = new Intent(this, Youtube_ReviewActivity.class);
    ...
    private void directTag(final VideoData video) {
        ...
        VideoSnippet snippet = video
                .addTags(Arrays.asList(
                        Youtube_Constants.DEFAULT_KEYWORD,
                        Upload.generateKeywordFromPlaylistId(Youtube_Constants.UPLOAD_PLAYLIST)));
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                YouTube youtube = new YouTube.Builder(transport, jsonFactory,
                        credential).setApplicationName(Youtube_Constants.APP_NAME)
                        .build();
                try {
    ...
    public void onVideoSelected(VideoData video) {
        mVideoData = video;
        Intent intent = new Intent(this, Youtube_PlayActivity.class);
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                        connectionStatusCode, Youtube_MainActivity.this,
