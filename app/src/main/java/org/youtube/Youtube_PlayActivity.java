 ...
 *         YT Android Player.
 */
public class Youtube_PlayActivity extends Activity implements
    ...
    public void panToVideo(final String youtubeId) {
        ...
        playerFragment.initialize(Youtube_Auth.KEY,
                new YouTubePlayer.OnInitializedListener() {
                    ...
                    public void onInitializationSuccess(
                        ...
                        youTubePlayer
                                .setPlayerStateChangeListener(Youtube_PlayActivity.this);
                        youTubePlayer
                                .setOnFullscreenListener(Youtube_PlayActivity.this);
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.youtube_activity_play);
        intent = getIntent();
        ...
        String youtubeId = intent.getStringExtra(Youtube_MainActivity.YOUTUBE_ID);
